 ...
 */
public class ContainerDarkDeconstructor extends Container
{
	public TileEntityDarkDeconstructor tile;
	...
	public ContainerDarkDeconstructor(InventoryPlayer ip, TileEntityDarkDeconstructor tileE)
	{
		this.tile = tileE;

		this.addSlotToContainer(new Slot(tileE, 0, 4 * 19 + 4, 60 - 15));
		this.addSlotToContainer(new Slot(tileE, 1, 8 * 19, 6 + 2));
		this.addSlotToContainer(new Slot(tileE, 2, 8 * 19 - 18, 6 + 2));
		this.addSlotToContainer(new Slot(tileE, 3, 8 * 19 - 36, 6 + 2));
		this.addSlotToContainer(new Slot(tileE, 4, 8 * 19 - 54, 6 + 2));
