...
public class AltarBasedStairs extends BlockStairs
{
	...
	private boolean field_150152_N = true;
	private final static Block field_150149_b = BlockRegistry.altar_base;
	private static int field_150153_O = 0;

	public AltarBasedStairs()
	{
		super(field_150149_b, field_150153_O);
	...
	{
		return this.field_150149_b.getMapColor(this.field_150153_O);
	}
	...
	public void setBlockBoundsBasedOnState(IBlockAccess p_149719_1_, int p_149719_2_, int p_149719_3_, int p_149719_4_)
	{
		...
		{
			this.setBlockBounds(0.5F * (float) (this.field_150153_O % 2), 0.5F * (float) (this.field_150153_O / 2 % 2), 0.5F * (float) (this.field_150153_O / 4 % 2), 0.5F + 0.5F * (float) (this.field_150153_O % 2),
					0.5F + 0.5F * (float) (this.field_150153_O / 2 % 2), 0.5F + 0.5F * (float) (this.field_150153_O / 4 % 2));
		}
		else
		{
