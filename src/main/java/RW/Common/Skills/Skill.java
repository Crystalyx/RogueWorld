...
public class Skill
{
	 ...
	 *            : Id of skill
	 * @param Sdamage
	 *            : Damage of attack with skill
	 * @param Saccuracy
	 *            : Chance to successfully attack entity
	 * @param Srange
	 *            : Range for range attacks; 0 for normal attack
	 * @param Sname
	 *            : Name of Skill that used in description
	 * @param Slev
	 *            : Level needed to get this Skill
	 * @param Type
	 *            : Type of Skill. 0 - Normal attack;1 - for Right Mouse
	 *            Button;2 - for Using;
	 **/
