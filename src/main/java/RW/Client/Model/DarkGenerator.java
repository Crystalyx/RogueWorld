...
/**
 * DarkTower - Lord_Crystalyx
 * Created using Tabula 4.1.1
 */
public class DarkGenerator extends ModelBase implements IItemRenderer{
    ...
    public DarkGenerator() {
        ...
        this.shape6.setRotationPoint(-5.0F, 21.0F, -5.0F);
        this.shape6.addBox(-1.0F, -22.0F, 0.0F, 2, 22, 2, 0.0F);
        this.setRotateAngle(shape6, -0.4363323129985824F, 0.7853981633974483F, 0.0F);
        ...
        this.shape5.setRotationPoint(5.0F, 21.0F, -5.0F);
        this.shape5.addBox(-1.0F, -22.0F, 0.0F, 2, 22, 2, 0.0F);
        this.setRotateAngle(shape5, -0.4363323129985824F, -0.7853981633974483F, 0.0F);
        this.shape8 = new ModelRenderer(this, 0, 0);
        this.shape8.setRotationPoint(-5.0F, 21.0F, 5.0F);
        this.shape8.addBox(-1.0F, -22.0F, 0.0F, 2, 22, 2, 0.0F);
        this.setRotateAngle(shape8, -0.4363323129985824F, 2.356194490192345F, 0.0F);
        ...
        this.shape7.setRotationPoint(5.0F, 21.0F, 5.0F);
        this.shape7.addBox(-1.0F, -22.0F, 0.0F, 2, 22, 2, 0.0F);
        this.setRotateAngle(shape7, -0.4363323129985824F, -2.356194490192345F, 0.0F);
        ...
        this.setRotateAngle(shape9, 0.7853981633974483F, 0.0F, 0.6154030942532006F);
    }
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) { 
        ...
        GL11.glScaled(0.25D, 0.5D, 0.25D);
        GL11.glTranslatef(-this.shape9.offsetX, -this.shape9.offsetY, -this.shape9.offsetZ);
        GL11.glTranslatef(-this.shape9.rotationPointX * f5, -this.shape9.rotationPointY * f5, -this.shape9.rotationPointZ * f5);
        GL11.glRotatef(Minecraft.getMinecraft().renderViewEntity.worldObj.getWorldTime() % 2880, 0, 1, 0);
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data)
	{
		...
		DarkDeconstructorRender.model.render(null, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
		Minecraft.getMinecraft().renderEngine.bindTexture(DarkDeconstructorRender.textures);
		GL11.glPopMatrix();	}
}
