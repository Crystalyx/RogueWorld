...
public class Spark extends EntityFX
{
	...
	public Spark(World w, double x, double y, double z, double i, double j, double k, double cR, double cG, double cB)
	{
		this(w, x, y, z, i, j, k);
	...
	public Spark(World w, WorldPos source, WorldPos velocity)
	{
	...
	public Spark(World w, WorldPos source, WorldPos velocity, double cR, double cG, double cB)
	{
		this(w, source.getX(), source.getY(), source.getZ(), velocity.getX(), velocity.getY(), velocity.getZ());
		this.particleRed = (float) cR;
		this.particleGreen = (float) cG;
